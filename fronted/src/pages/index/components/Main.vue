<template>
  <div class="home-des">
    <div class="logo">
      ...
      <span class="name">微博谣言检测系统系统</span>
    </div>
    <div class="detail">具体信息 balbalbalbal<br>
    ...
    <div class="search">
      <!-- <h3>微博用户爬虫</h3> -->
      <input type="text" class="search-text" placeholder="请输入微博谣言信息" ref="keyword">
      <a href="#">
        <button type="button" class="search-scrapy" @click="getWbrumor">
          <span>爬虫一下</span>
        </button>
      </a>
    </div>
...
export default {
  ...
  methods: {
    getWbrumor: function () {
      ...
      if (this.weiboId.length > 100) {
        this.openFullScreen2()
        console.log('zq')
        axios.post('http://localhost:8000/keyword/',
          Qs.stringify({
